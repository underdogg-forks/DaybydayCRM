...
description: "Enforces grammatically correct, intention-revealing PHPUnit test method names in this project"
triggers:
...
```
"It returns 404 for a nonexistent lead."
"It stores the lead and fires the LeadAction event."
"It rejects payment when the invoice has not been sent."
```

## ✅ Correct

```php
public function it_returns_200_when_client_is_found(): void {}
public function it_redirects_to_index_when_user_lacks_permission(): void {}
public function it_stores_lead_with_valid_payload(): void {}
public function it_rejects_invalid_status_for_task(): void {}
public function it_soft_deletes_project_and_preserves_tasks(): void {}
public function it_sends_403_json_when_document_access_is_denied(): void {}
public function it_creates_invoice_line_and_attaches_it_to_offer(): void {}
public function it_calculates_total_price_excluding_vat(): void {}
...
// ✅
#[Test]
public function it_creates_lead(): void {}
```
