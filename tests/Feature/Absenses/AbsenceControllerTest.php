...
class AbsenceControllerTest extends AbstractTestCase
{
    ...
    {
        /* Arrange: default test user is an Owner (full permissions, including
         * absence-view), so the success redirect still goes to absence.index. */
    ...
    #[Test]
    public function it_returns_validation_error_for_invalid_absence_reason(): void
    {
        /* Arrange */
        ...
        $this->assertCount(0, $this->user->fresh()->absences);
    }

    #[Test]
    public function it_returns_validation_error_when_end_date_is_before_start_date(): void
    {
        /* Arrange */
